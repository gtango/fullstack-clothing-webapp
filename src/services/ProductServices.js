...
// async getFilteredProducts(gender) {
//     const res = await axios.get(USER_API_BASE_URL + gender + '/all/page=' + 0 + '&items_per_page=' + 10 + '/low');
//   return res.data;
//   }
// }
// function getItemByUpc(upc){
//   return axios.get(USER_API_BASE_URL + "item/" + upc);
// }
